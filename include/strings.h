...
extern const u8 gText_DefaultNameStewart[];
extern const u8 gText_DefaultNameMilton[];
extern const u8 gText_DefaultNameTom[];
extern const u8 gText_DefaultNameKenny[];
extern const u8 gText_DefaultNameRay[];
extern const u8 gText_DefaultNameBrad[];
extern const u8 gText_DefaultNameJackson[];
extern const u8 gText_DefaultNameEric[];
extern const u8 gText_DefaultNameWally[];
extern const u8 gText_DefaultNameTed[];
...
extern const u8 gText_DefaultNameDaryl[];
extern const u8 gText_DefaultNameLenny[];
extern const u8 gText_DefaultNameColin[];
extern const u8 gText_DefaultNameStanley[];
extern const u8 gText_DefaultNameMatt[];
extern const u8 gText_DefaultNameSophie[];
...
extern const u8 gText_DefaultNameCamilla[];
extern const u8 gText_DefaultNameLisa[];
extern const u8 gText_DefaultNameBethany[];
extern const u8 gText_DefaultNameZoey[];
extern const u8 gText_DefaultNameNadia[];
extern const u8 gText_DefaultNameAngela[];
extern const u8 gText_DefaultNameYasmin[];
extern const u8 gText_DefaultNameNicole[];
extern const u8 gText_DefaultNameLillie[];
extern const u8 gText_DefaultNameAthena[];
extern const u8 gText_DefaultNameLucy[];
extern const u8 gText_DefaultNameHaley[];
