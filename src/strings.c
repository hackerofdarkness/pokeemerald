...
const u8 gText_UnkCtrlF908Clear01[] = _("{CLEAR 0x01}");
...
const u8 gText_XNatureHatchedSomewhereAt[] = _("Hatched somewhere at {LV_2}{SPECIAL_F7 0x00}{SPECIAL_F7 0x03}{SPECIAL_F7 0x01}.");
