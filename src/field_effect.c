...
const u32 gNewGameBirchPic2[] = INCBIN_U32("graphics/birch_speech/birch2.4bpp");
...
const struct SpriteFrameImage gNewGameBirchPic2Table[] = {
	obj_frame_tiles(gNewGameBirchPic2)
};
...
const struct SpriteTemplate gNewGameBirchObjectTemplate2 = {
	.tileTag = 0xffff,
	.paletteTag = 4102,
	.oam = &gNewGameBirchOamAttributes,
	.anims = gNewGameBirchImageAnimTable,
	.images = gNewGameBirchPic2Table,
	.affineAnims = gDummySpriteAffineAnimTable,
	.callback = SpriteCallbackDummy
};
...
u8 AddNewGameBirchObject2(s16 x, s16 y, u8 subpriority)
{
	LoadSpritePalette(&gNewGameBirchObjectPaletteInfo);
	return CreateSprite(&gNewGameBirchObjectTemplate2, x, y, subpriority);
}
